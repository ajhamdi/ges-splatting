...
class LaplacianModel:
    ...
    def setup_functions(self):
        ...
        self.opacity_activation = torch.sigmoid # torch.nn.functional.tanh
        self.inverse_opacity_activation =  inverse_sigmoid # torch.atanh
        self.opacity_activation = torch.sigmoid # torch.nn.functional.tanh
        self.shape_activation = var_approx # var_generalized
    ...
    def load_ply(self, path):
        ...
        shapes = torch.zeros((xyz.shape[0], 1), dtype=torch.float, device="cuda") 
    ...
    def replace_tensor_to_optimizer_shape(self, tensor, name):
        optimizable_tensors = {}
        for group in self.optimizer.param_groups:
            if group["name"] == name:
                stored_state = self.optimizer.state.get(group['params'][0], None)
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities,new_shapes, new_scaling, new_rotation):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacity,new_shape, new_scaling, new_rotation)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities,new_shapes, new_scaling, new_rotation)
